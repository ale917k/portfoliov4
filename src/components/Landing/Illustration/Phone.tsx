  ...
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 672 379">
    ...
    <g clipPath="url(#clip0)">
      <g>
        ...
        />
        <path fill={theme.palette.primary} d="M473.167 77.195h132.44l14.11 63.538-134.172 2.474-12.378-66.012z" />
        <path fill={theme.palette.primary} d="M598.923 197.541h31.191l.99 5.938h-31.191l-.99-5.938z" />
        ...
        <path fill={theme.palette.primary} d="M611.795 261.376h31.192l.99 5.938h-31.191l-.991-5.938z" />
